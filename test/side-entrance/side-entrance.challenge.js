...
const AttackerContract = contract.fromArtifact('AttackerContract');
...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        ...
        const attackerContract = await AttackerContract.new({ from: attacker });
        await attackerContract.reentrancyAttack(this.pool.address, { from: attacker })
    });
